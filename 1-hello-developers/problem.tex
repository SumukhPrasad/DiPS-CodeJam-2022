...
\begin{document}
	...
	\section*{Prompt}
    Given a random string \textit{n} of length $\ge$ 100 characters, print a formatted string \texttt{Hello, <n>!}. The first (and the only) input line contains \textit{n} -- which you have to format.\\
