...
\begin{document}
  ...
  \section*{Prompt}
  Pranav and Prithvi are playing a game of \textit{Strange Numbers}. Pranav gives Prithvi 2 numbers, $x$ and $k$. Prithvi now needs to determine wether there is an integer $a$, such that it has $x$ positive divisors and exactly $k$ of them are prime numbers. Can you help him?
